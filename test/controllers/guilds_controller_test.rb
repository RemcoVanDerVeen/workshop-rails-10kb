...
class GuildsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guild" do
    assert_difference("Guild.count") do
      post guilds_url, params: { guild: { founded_on: @guild.founded_on, motto: @guild.motto, name: @guild.name } }
    end
  ...
  test "should update guild" do
    patch guild_url(@guild), params: { guild: { founded_on: @guild.founded_on, motto: @guild.motto, name: @guild.name } }
